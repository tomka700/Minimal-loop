...
| 12 | 56?    | 24?      | 32?      | 0?       | 3?                 | 12?         |
| 13 | 67?    | 32?      | 35?      | 0?       | 15?                | 120?        |
| 14 | 78?    | 38?      | 40?      | 0?       | 150+?              | 1000+?      |
| 15 | 87?    | 36?      | 51?      | 0?       | 8?                 | 64?         |
| 16 | 98?    | 38?      | 60?      | 0?       | 92?                | 736?        |
| 17 | 109?   | 38?      | 71?      | 0?       |                    |             |
| 18 | 120?   | 36?      | 84?      | 0?       |                    |             |
||||||||
| 0 mod 6 | $\le\frac{n(n+2)}{3}$ | 2n? | $\le\frac{n(n-4)}{3}$ | 0? |||
| 1 mod 6 $\ge$ 13 | $\le\frac{n(n+2)+6}{3}$ | 2n+6? | $\le\frac{n(n-4)-12}{3}$ | 0? |||
| 2 mod 6 $\ge$ 14 | $\le\frac{n(n+2)+10}{3}$ | 2n+10? | $\le\frac{n(n-4)-20}{3}$ | 0? |||
| 3 mod 6 $\ge$ 9 | $\le\frac{n(n+2)+6}{3}$ | 2n+6? | $\le\frac{n(n-4)-12}{3}$ | 0? |||
| 4 mod 6 $\ge$ 10 | $\le\frac{n(n+2)+6}{3}$ | 2n+6? | $\le\frac{n(n-4)-12}{3}$ | 0? |||
| 5 mod 6 $\ge$ 11 | $\le\frac{n(n+2)+4}{3}$ | 2n+4? | $\le\frac{n(n-4)-8}{3}$ | 0? |||

...
||||||||
| 0 mod 6 | $\frac{n(n+2)}{3}\text{?}$ | 2n? | $\frac{n(n-4)}{3}\text{?}$ | 0? | $\binom{\frac{n}{6}}{\lfloor \frac{n}{12}\rfloor} + \binom{\frac{n}{6}-1}{\lfloor\frac{\frac{n}{6}-1}{2}\rfloor}\text{?}$ | $2^{\frac{n}{6}+1}+2^{\frac{n}{6}}\text{?}$ |

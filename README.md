...
| 1 mod 6 $\ge$ 13 | $\frac{n(n+2)}{3}\text{?}$ | 2n+6? | $\frac{n(n-4)-12}{3}\text{?}$ | 0? |||
| 2 mod 6 $\ge$ 14 | $\frac{n(n+2)}{3}\text{?}$ | 2n+10? | $\frac{n(n-4)-20}{3}\text{?}$ | 0? |||
| 3 mod 6 $\ge$ 9 | $\frac{n(n+2)}{3}\text{?}$ | 2n+6? | $\frac{n(n-4)-12}{3}\text{?}$ | 0? |||
| 4 mod 6 $\ge$ 10 | $\frac{n(n+2)}{3}\text{?}$ | 2n+6? | $\frac{n(n-4)-12}{3}\text{?}$ | 0? |||
| 5 mod 6 $\ge$ 11 | $\frac{n(n+2)}{3}\text{?}$ | 2n+4? | $\frac{n(n-4)-8}{3}\text{?}$ | 0? |||
